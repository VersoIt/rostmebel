      ...
      <div class="mx-auto grid max-w-7xl grid-cols-1 gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:items-start">
        <div>
          ...
          <p class="mt-5 leading-8 text-brand-brown/68">
            Вдохновились у homi идеей готовой комплектации, но адаптировали под мебельное производство: заранее собираем состав проекта, зоны ответственности и точки контроля.
          </p>
        </div>
